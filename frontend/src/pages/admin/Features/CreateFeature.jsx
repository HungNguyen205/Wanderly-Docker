...
export default function CreateFeature() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        const errorMessage = responseData.message || responseData.error || `Failed to create feature: ${res.status}`;
        toast.error(errorMessage);
        throw new Error(errorMessage);
      }

      // Success - show toast and navigate back
      const successMessage = responseData.message || 'Feature created successfully!';
      ...
      const errorMessage = err.message || "Failed to create feature";
      toast.error(errorMessage);
  ...
  return (
    <AdminLayout title="Create New Feature">
        ...
        <div className="max-w-4xl">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-2xl font-bold text-gray-900">Add New Feature</h2>
              <p className="text-gray-500 text-sm mt-1">Fill in the details to create a new feature</p>
            </div>
